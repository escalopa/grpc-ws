...
func request_ChatService_JoinChat_0(ctx context.Context, marshaler runtime.Marshaler, client ChatServiceClient, req *http.Request, pathParams map[string]string) (ChatService_JoinChatClient, runtime.ServerMetadata, error) {
...
func RegisterChatServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChatServiceClient) error {
	...
	mux.Handle("POST", pattern_ChatService_JoinChat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.ChatService/JoinChat", runtime.WithHTTPPathPattern("/ChatService/JoinChat"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		...
		forward_ChatService_JoinChat_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ChatService_JoinChat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ChatService", "JoinChat"}, ""))
)

var (
	forward_ChatService_JoinChat_0 = runtime.ForwardResponseStream
)
